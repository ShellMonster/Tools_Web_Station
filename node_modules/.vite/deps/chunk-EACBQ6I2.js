...
// node_modules/mermaid/dist/chunks/mermaid.esm/chunk-COUQ6RZ3.mjs
...
var memoize$1 = __name(function memoize(fn3, keyFn) {
  if (!keyFn) {
  ...
  var memoizedFn = __name(function memoizedFn2() {
    var self2 = this;
    var args = arguments;
    var ret;
...
var copyArray$1 = __name(function copyArray(arr) {
  return arr.slice();
}, "copyArray");
...
var shiftBoundingBox = __name(function shiftBoundingBox2(bb, dx, dy) {
  return {
    x1: bb.x1 + dx,
    x2: bb.x2 + dx,
    y1: bb.y1 + dy,
...
var elesfn$l = {
  ...
  betweennessCentrality: __name(function betweennessCentrality(options2) {
    ...
    var _loop = __name(function _loop2(s2) {
      var sid = V[s2].id();
      var S = [];
      var P = {};
      var g = {};
...
var getAllChildren = __name(function getAllChildren2(root2, arr, cy) {
  if (!root2) return;
  if (root2.value) {
...
var buildDendrogram = __name(function buildDendrogram2(root2, cy) {
  if (!root2) return "";
...
var buildClustersFromTree = __name(function buildClustersFromTree2(root2, k, cy) {
  if (!root2) return [];
...
var hopcroftTarjanBiconnected = __name(function hopcroftTarjanBiconnected2() {
  ...
  var biconnectedSearch = __name(function biconnectedSearch2(root2, currentNode, parent4) {
...
var tarjanStronglyConnected = __name(function tarjanStronglyConnected2() {
  ...
  var stronglyConnectedSearch = __name(function stronglyConnectedSearch2(sourceNodeId) {
...
var api = __name(function api2(executor) {
...
var resolve = __name(function resolve2(promise4, x2) {
...
var cachedBoundingBoxImpl = __name(function cachedBoundingBoxImpl2(ele, opts) {
  ...
  var isDirty = __name(function isDirty2(ele2) {
...
p.emit = p.trigger = function(events, extraParams, manualCallback) {
  ...
  forEachEventObj(this, function(self2, eventObj) {
    ...
    var _loop2 = __name(function _loop22(i22) {
      var listener = listeners[i22];
...
var elesfn$5 = {
  ...
  layoutPositions: __name(function layoutPositions(layout4, options2, fn3) {
    ...
    var bb = spacingBb();
    var getFinalPos = memoize$1(function(node2, i22) {
...
extend(elesfn$2, {
  components: __name(function components(root2) {
    var self2 = this;
    var cy = self2.cy();
...
var corefn$8 = {
  ...
  startAnimationLoop: __name(function startAnimationLoop() {
    ...
    function headlessStep() {
      ...
      requestAnimationFrame(__name(function animationStep(now2) {
        stepAll(now2, cy);
        headlessStep();
      }, "animationStep"));
    }
    ...
    if (renderer3 && renderer3.beforeRender) {
      renderer3.beforeRender(__name(function rendererAnimationStep(willDraw, now2) {
        stepAll(now2, cy);
...
var Style = __name(function Style2(cy) {
...
BreadthFirstLayout.prototype.run = function() {
  ...
  if (elementOrCollection(options2.roots)) {
    ...
    if (directed) {
      ...
      roots = cy.collection();
      var _loop = __name(function _loop2(_i4) {
...
CoseLayout.prototype.run = function() {
  ...
  if (options2.animate === true) {
    var frame = __name(function frame2() {
      var f = 0;
...
var findLCA_aux = __name(function findLCA_aux2(node1, node2, graphIx, layoutInfo) {
...
var updateAncestryBoundaries = __name(function updateAncestryBoundaries2(node, layoutInfo) {
...
BRp$f.registerArrowShapes = function() {
  ...
  var transformPoints = __name(function transformPoints2(pts2, size3, angle2, translation) {
    var retPts = [];
...
BRp$c.findEdgeControlPoints = function(edges3) {
  ...
  var hashTable = {
    map: new Map$2(),
    get: __name(function get2(pairId2) {
    ...
    set: __name(function set2(pairId2, val) {
      var map2 = this.map.get(pairId2[0]);
      if (map2 == null) {
        map2 = new Map$2();
  ...
  var _loop = __name(function _loop2(p3) {
...
BRp$9.recalculateEdgeLabelProjections = function(edge) {
  ...
  var createControlPointInfo = __name(function createControlPointInfo2() {
...
BRp$1.startRenderLoop = function() {
  ...
  var renderFn = __name(function renderFn2(requestTime) {
    if (r.destroyed) {
      return;
    }
    if (cy.batching()) ;
...
var AtlasCollection = (function() {
  ...
  _createClass(AtlasCollection2, [{
    ...
    key: "draw",
    value: __name(function draw(id2, key, bb, doDrawing) {
    ...
    key: "deleteKey",
    value: __name(function deleteKey(id2, key) {
      this.idToKey["delete"](id2);
      this.getIdsFor(key)["delete"](id2);
    }, "deleteKey")
  }, {
    key: "checkKeyIsInvalid",
    value: __name(function checkKeyIsInvalid(id2, newKey) {
    ...
    value: __name(function _getKeysToCollect() {
...
var AtlasManager = (function() {
  ...
  _createClass(AtlasManager2, [{
    ...
    value: __name(function _cacheScratchCanvas(opts) {
      var prevW = -1;
      var prevH = -1;
    ...
    key: "getRenderTypes",
    value: __name(function getRenderTypes() {
    ...
    key: "isRenderable",
    value: __name(function isRenderable(ele, type) {
    ...
    value: __name(function getOrCreateAtlas(ele, bb, type) {
    ...
    value: __name(function canAddToCurrentBatch(ele, type) {
      if (this.batchAtlases.length === this.maxAtlasesPerBatch) {
        var opts = this.renderTypes.get(type);
        var styleKey = opts.getKey(ele);
    ...
    value: __name(function setTransformMatrix(matrix, atlasInfo, ele) {
    ...
    value: __name(function getTransformMatrix(atlasInfo, ele) {
    ...
    key: "getAdjustedBB",
    value: __name(function getAdjustedBB(bb, padding, first2, ratio) {
      var x1 = bb.x1, y1 = bb.y1, w = bb.w, h = bb.h;
      if (padding) {
        x1 -= padding;
        y1 -= padding;
...
var ElementDrawingWebGL = (function() {
  ...
  _createClass(ElementDrawingWebGL2, [{
    ...
    value: __name(function addTextureRenderType(type, opts) {
    ...
    value: __name(function createShaderProgram(renderTarget) {
      var gl = this.gl;
    ...
    key: "createVAO",
    value: __name(function createVAO() {
    ...
    key: "startFrame",
    value: __name(function startFrame(panZoomMatrix, debugInfo) {
    ...
    key: "getTempMatrix",
    value: __name(function getTempMatrix() {
    ...
    key: "getEdgePoints",
    value: __name(function getEdgePoints(edge) {
      var rs = edge._private.rscratch;
    ...
    key: "getNumSegments",
    value: __name(function getNumSegments(edge) {
      var numSegments = 15;
      return Math.min(Math.max(numSegments, 5), this.maxInstances);
    }, "getNumSegments")
  }, {
    key: "getCurveSegmentPoints",
    value: __name(function getCurveSegmentPoints(controlPoints3, segments) {
      if (controlPoints3.length == 4) {
        return controlPoints3;
      }
      ...
      for (var i2 = 0; i2 <= segments; i2++) {
        if (i2 == 0) {
          ...
          var t = i2 / segments;
          this.setCurvePoint(controlPoints3, t, curvePoints, i2 * 2);
        }
      }
      return curvePoints;
    ...
    key: "setCurvePoint",
    value: __name(function setCurvePoint(points, t, curvePoints, cpi) {
      if (points.length <= 2) {
    ...
    value: __name(function getAtlasDebugInfo() {
...
var OverlayUnderlayRenderer = (function() {
  ...
  _createClass(OverlayUnderlayRenderer2, [{
    key: "getStyleKey",
    value: __name(function getStyleKey(type, node) {
    ...
    key: "isVisible",
    value: __name(function isVisible(type, node) {
      var opacity = node.pstyle("".concat(type, "-opacity")).value;
      return opacity > 0;
    }, "isVisible")
  }, {
    key: "getStyle",
    value: __name(function getStyle(type, node) {
      var opacity = node.pstyle("".concat(type, "-opacity")).value;
    ...
    key: "getPadding",
    value: __name(function getPadding(type, node) {
      return node.pstyle("".concat(type, "-padding")).pfValue;
    }, "getPadding")
  }, {
    key: "draw",
    value: __name(function draw(type, context, node, bb) {
...
CRp$4.initWebgl = function(opts, fns) {
  ...
  var getLabelRotation3 = __name(function getLabelRotation4(ele) {
    return r.getTextAngle(ele, null);
  }, "getLabelRotation");
  var isLabelVisible = __name(function isLabelVisible2(ele) {
    var label = ele.pstyle("label");
  ...
  r.eleDrawing.addTextureRenderType("node-body", renderDefaults({
    ...
    isVisible: __name(function isVisible(ele) {
      return ele.visible();
    }, "isVisible")
  }));
  ...
  r.eleDrawing.addTextureRenderType("node-overlay", renderDefaults({
    getBoundingBox: fns.getElementBox,
    getKey: __name(function getKey3(ele) {
      return our.getStyleKey("overlay", ele);
    }, "getKey"),
    drawElement: __name(function drawElement(ctx, ele, bb) {
      return our.draw("overlay", ctx, ele, bb);
    }, "drawElement"),
    isVisible: __name(function isVisible(ele) {
      return our.isVisible("overlay", ele);
    }, "isVisible"),
    getPadding: __name(function getPadding(ele) {
...
function drawAtlases(r) {
  var draw = __name(function draw2(drawing, renderType, row) {
  ...
  var i2 = 0;
  draw(r.eleDrawing, "node-body", i2++);
  draw(r.eleDrawing, "node-label", i2++);
}
...
function renderWebgl(r, options2, renderTarget) {
  ...
  if (r.data.canvasNeedsRedraw[r.NODE] || renderTarget.picking) {
    var draw = __name(function draw2(ele, index) {
      index += 1;
      if (ele.isNode()) {
...
var Stylesheet = __name(function Stylesheet2() {
...
mermaid/dist/chunks/mermaid.esm/chunk-COUQ6RZ3.mjs:
  (*! Bundled license information:
  ...
  *)
*/
//# sourceMappingURL=chunk-EACBQ6I2.js.map
