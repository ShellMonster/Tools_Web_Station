import {
  package_default
} from "./chunk-CDOVANJZ.js";
import {
  selectSvgElement
} from "./chunk-7F4I45CM.js";
import {
  JSON_SCHEMA,
  load
} from "./chunk-U3PUXGNX.js";
import {
  registerLayoutLoaders
} from "./chunk-LFV435LQ.js";
import "./chunk-OTF3TWNQ.js";
import "./chunk-376KTMLC.js";
import "./chunk-UZEHEFO3.js";
import "./chunk-HMWPYI5A.js";
import "./chunk-THDOFVMM.js";
import {
  dedent,
  registerIconPacks
} from "./chunk-WZARYGQF.js";
import {
  isEmpty_default
...
import {
  ...
  removeDirectives,
  utils_default
} from "./chunk-ORS36LUQ.js";
import "./chunk-DDXQOTFD.js";
import {
  UnknownDiagramError,
  addDirective,
  ...
  themes_default,
  updateSiteConfig
} from "./chunk-SAK5B54Y.js";
import "./chunk-RBZKTJGR.js";
import {
  log,
  select_default2,
  setLogLevel
} from "./chunk-BYFACFKZ.js";
import {
  __name
...
var loader = __name(async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-SQLIB6GY-VCO7AMFR.js");
...
var loader2 = __name(async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-FOWAVQJE-O2JD6WNW.js");
...
var loader4 = __name(async () => {
  const { diagram: diagram2 } = await import("./erDiagram-XMCKW3CS-CIEI7HV2.js");
...
var loader5 = __name(async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-R54AEOJC-XEUNOYOS.js");
...
var loader6 = __name(async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-46IUWRTB-UVNPGBYN.js");
...
var loader7 = __name(async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-GPC3PUZZ-RTXMZGXM.js");
...
var loader8 = __name(async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-5IAYJKRZ-OVYAA7XT.js");
...
var loader9 = __name(async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-5ZWEAEXR-DFGF2XEQ.js");
...
var loader10 = __name(async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-5RH64VQB-H67CCHVE.js");
...
var loader11 = __name(async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-M7RGTXBH-Q226NFMY.js");
...
var loader12 = __name(async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-ISRA3MRE-XUDLIGOC.js");
...
var loader13 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-7ANXANW4-MHO2AOXG.js");
...
var loader14 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-MZV5ZTKF-BZWOCGUH.js");
...
var loader15 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-CJBUTBSI-UWVF3AI7.js");
...
var loader16 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-KZMHAS5D-4NW7J7O7.js");
...
var loader17 = __name(async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-4TCMJ5EM-K7K2VMGQ.js");
...
var loader19 = __name(async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-K5C5YAQR-LSHG6ZGZ.js");
...
var loader20 = __name(async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-V4EK3GGT-6TJXUA5U.js");
...
var loader21 = __name(async () => {
  const { diagram: diagram2 } = await import("./kanban-definition-52RHVUC7-EYPMQH2X.js");
...
var loader22 = __name(async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-PCQIIBHD-IJLXB23F.js");
...
var loader23 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-HOELL6W4-JLKAITFI.js");
...
var loader24 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-FXKTIKZ5-YFW6Q3VT.js");
...
var loader25 = __name(async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-GFS4DT2Z-SA4DGMHA.js");
...
var loader26 = __name(async () => {
  const { diagram: diagram2 } = await import("./architectureDiagram-ZPBSDZBN-SHAGTQWN.js");
...
var loader27 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-XWL5YNBM-EQGM4XGO.js");
