...
// node_modules/mermaid/dist/chunks/mermaid.esm/chunk-CGAWHQUF.mjs
  ...
  var indentLengths = strings.reduce(function(arr, str) {
    ...
    if (matches) {
      return arr.concat(matches.map(function(match) {
        var _a8, _b;
        return (_b = (_a8 = match.match(/[\t ]/g)) === null || _a8 === void 0 ? void 0 : _a8.length) !== null && _b !== void 0 ? _b : 0;
      }));
    }
    return arr;
  }, []);
...
var other = {
  ...
  notSpaceStart: /^\S*/,
  endingNewline: /\n$/,
  listItemRegex: __name((bull) => new RegExp(`^( {0,3}${bull})((?:[	 ][^\\n]*)?(?:\\n|$))`), "listItemRegex"),
  nextBulletRegex: __name((indent) => new RegExp(`^ {0,${Math.min(3, indent - 1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`), "nextBulletRegex"),
  hrRegex: __name((indent) => new RegExp(`^ {0,${Math.min(3, indent - 1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`), "hrRegex"),
  fencesBeginRegex: __name((indent) => new RegExp(`^ {0,${Math.min(3, indent - 1)}}(?:\`\`\`|~~~)`), "fencesBeginRegex"),
  headingBeginRegex: __name((indent) => new RegExp(`^ {0,${Math.min(3, indent - 1)}}#`), "headingBeginRegex"),
  htmlBeginRegex: __name((indent) => new RegExp(`^ {0,${Math.min(3, indent - 1)}}<(?:[a-z].*>|!--)`, "i"), "htmlBeginRegex")
};
var newline = /^(?:[ \t]*(?:\n|$))+/;
var blockCode = /^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/;
var fences = /^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/;
...
var getEscapeReplacement = __name((ch) => escapeReplacements[ch], "getEscapeReplacement");
...
}, __name(_a2, "__Lexer"), _a2);
var _a3;
var _Renderer = (_a3 = class {
  options;
  parser;
  // set by the parser
  constructor(options2) {
...
}, __name(_a3, "_Renderer"), _a3);
var _a4;
var _TextRenderer = (_a4 = class {
...
}, __name(_a4, "_TextRenderer"), _a4);
var _a5;
var _Parser = (_a5 = class {
  options;
  renderer;
  textRenderer;
  constructor(options2) {
  ...
  static parse(tokens, options2) {
    const parser2 = new _a5(options2);
...
}, __name(_a5, "__Parser"), _a5);
var _a6;
var _Hooks = (_a6 = class {
  options;
  block;
  constructor(options2) {
    this.options = options2 || _defaults;
...
}, __name(_a6, "_Hooks"), __publicField(_a6, "passThroughHooks", /* @__PURE__ */ new Set([
  "preprocess",
  "postprocess",
  "processAllTokens"
])), _a6);
var _a7;
var Marked = (_a7 = class {
  ...
  parseMarkdown(blockType) {
    const parse2 = __name((src, options2) => {
...
//# sourceMappingURL=chunk-WZARYGQF.js.map
