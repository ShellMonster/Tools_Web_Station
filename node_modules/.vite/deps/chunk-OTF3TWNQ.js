...
// node_modules/mermaid/dist/chunks/mermaid.esm/chunk-XNMDYEEV.mjs
...
var insertEdge = __name(function(elem, edge, clusterDb, diagramType, startNode, endNode, id) {
  ...
  if (edge.look === "handDrawn") {
    ...
    svgPath = select_default2(svgPathNode).select("path").attr("id", edge.id).attr("class", " " + strokeClasses + (edge.classes ? " " + edge.classes : "")).attr("style", edgeStyles ? edgeStyles.reduce((acc, style) => acc + ";" + style, "") : "");
...
//# sourceMappingURL=chunk-OTF3TWNQ.js.map
