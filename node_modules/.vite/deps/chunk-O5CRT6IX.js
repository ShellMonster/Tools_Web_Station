import {
  ...
  uniq_default,
  values_default
} from "./chunk-YC3P77RE.js";
import {
  isEmpty_default
} from "./chunk-3XJAMTF7.js";
import {
  identity_default,
  isArray_default,
  isFunction_default,
  isObject_default
} from "./chunk-RBZKTJGR.js";
import {
  __commonJS,
  __export,
  __name,
  __reExport,
  __toESM
} from "./chunk-RDUXDGWX.js";

// node_modules/mermaid/dist/chunks/mermaid.esm/chunk-YOB5EFFC.mjs
...
var require_events = __commonJS({
  "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/events.js"(exports) {
    ...
    }, __name(_a130, "CallbackList"), _a130);
    var Emitter3 = (_b = class {
...
var require_cancellation = __commonJS({
  "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/cancellation.js"(exports) {
    ...
    }, __name(_a130, "MutableToken"), _a130);
    var CancellationTokenSource3 = (_b = class {
      get token() {
        if (!this._token) {
    ...
    }, __name(_b, "CancellationTokenSource"), _b);
...
var _a;
var AbstractAstReflection = (_a = class {
  constructor() {
    this.subtypes = {};
    this.allSubtypes = {};
  }
...
}, __name(_a, "AbstractAstReflection"), _a);
...
var StreamImpl = (_a2 = class {
  ...
  concat(other) {
    return new _a2(() => ({ first: this.startFn(), firstDone: false, iterator: other[Symbol.iterator]() }), (state) => {
      let result;
      if (!state.firstDone) {
        do {
  ...
  map(callbackfn) {
    return new _a2(this.startFn, (state) => {
  ...
  flatMap(callbackfn) {
    return new _a2(() => ({ this: this.startFn() }), (state) => {
      do {
        if (state.iterator) {
  ...
  flat(depth) {
    ...
    return new _a2(() => ({ this: stream2.startFn() }), (state) => {
      do {
        if (state.iterator) {
          const next = state.iterator.next();
          if (next.done) {
  ...
  limit(maxSize) {
    return new _a2(() => ({ size: 0, state: this.startFn() }), (state) => {
      state.size++;
  ...
  distinct(by) {
    return new _a2(() => ({ set: /* @__PURE__ */ new Set(), internalState: this.startFn() }), (state) => {
      let result;
      do {
...
var _a3;
var TreeStreamImpl = (_a3 = class extends StreamImpl {
...
var _a4;
var ErrorWithLocation = (_a4 = class extends Error {
  constructor(node, message) {
    super(node ? `${message} at ${node.range.start.line}:${node.range.start.character}` : message);
  }
}, __name(_a4, "ErrorWithLocation"), _a4);
...
var _a5;
var LangiumGrammarAstReflection = (_a5 = class extends AbstractAstReflection {
  getAllTypes() {
...
}, __name(_a5, "LangiumGrammarAstReflection"), _a5);
...
function isAstNodeInRange(astNode, range) {
  ...
  const nodeRange = (_a130 = astNode.$cstNode) === null || _a130 === void 0 ? void 0 : _a130.range;
  if (!nodeRange) {
    return false;
  }
...
}, __name(_a6, "RegExpParser"), _a6);
var _a7;
var BaseRegExpVisitor = (_a7 = class {
  visitChildren(node) {
...
}, __name(_a7, "BaseRegExpVisitor"), _a7);
var NEWLINE_REGEXP = /\r?\n/gm;
var regexpParser = new RegExpParser();
var _a8;
var TerminalRegExpVisitor = (_a8 = class extends BaseRegExpVisitor {
  constructor() {
    super(...arguments);
...
}, __name(_a8, "TerminalRegExpVisitor"), _a8);
...
function findAssignment(cstNode) {
  ...
  while (astNode === ((_a130 = cstNode.container) === null || _a130 === void 0 ? void 0 : _a130.astNode)) {
...
function findNameAssignmentInternal(type, startNode, cache) {
  ...
  for (const node of streamAllContents(startNode)) {
    ...
    } else if (isSimpleType(node) && ((_a130 = node.typeRef) === null || _a130 === void 0 ? void 0 : _a130.ref)) {
...
function getTypeName(type) {
  ...
  if (isParserRule(type)) {
    return isDataTypeRule(type) ? type.name : (_a130 = getExplicitRuleType(type)) !== null && _a130 !== void 0 ? _a130 : type.name;
...
function getActionType(action) {
  ...
  } else if ((_a130 = action.type) === null || _a130 === void 0 ? void 0 : _a130.ref) {
...
function getRuleTypeName(rule) {
  ...
  if (isTerminalRule(rule)) {
    return (_b = (_a130 = rule.type) === null || _a130 === void 0 ? void 0 : _a130.name) !== null && _b !== void 0 ? _b : "string";
  } else {
...
function withCardinality(regex, options) {
  ...
  if (options.wrap !== false || options.lookahead) {
    regex = `(${(_a130 = options.lookahead) !== null && _a130 !== void 0 ? _a130 : ""}${regex})`;
  }
...
var _a9;
var AbstractProduction = (_a9 = class {
  get definition() {
...
}, __name(_a9, "AbstractProduction"), _a9);
var _a10;
var NonTerminal = (_a10 = class extends AbstractProduction {
  constructor(options) {
    super([]);
    this.idx = 1;
...
}, __name(_a10, "NonTerminal"), _a10);
var _a11;
var Rule = (_a11 = class extends AbstractProduction {
  constructor(options) {
    super(options.definition);
    this.orgText = "";
    assign_default(this, pickBy_default(options, (v) => v !== void 0));
  }
}, __name(_a11, "Rule"), _a11);
var _a12;
var Alternative = (_a12 = class extends AbstractProduction {
  constructor(options) {
    super(options.definition);
    this.ignoreAmbiguities = false;
    assign_default(this, pickBy_default(options, (v) => v !== void 0));
  }
}, __name(_a12, "Alternative"), _a12);
var _a13;
var Option = (_a13 = class extends AbstractProduction {
  constructor(options) {
    super(options.definition);
    this.idx = 1;
    assign_default(this, pickBy_default(options, (v) => v !== void 0));
  }
}, __name(_a13, "Option"), _a13);
var _a14;
var RepetitionMandatory = (_a14 = class extends AbstractProduction {
  constructor(options) {
    super(options.definition);
    this.idx = 1;
    assign_default(this, pickBy_default(options, (v) => v !== void 0));
  }
}, __name(_a14, "RepetitionMandatory"), _a14);
var _a15;
var RepetitionMandatoryWithSeparator = (_a15 = class extends AbstractProduction {
  constructor(options) {
    super(options.definition);
    this.idx = 1;
    assign_default(this, pickBy_default(options, (v) => v !== void 0));
  }
}, __name(_a15, "RepetitionMandatoryWithSeparator"), _a15);
var _a16;
var Repetition = (_a16 = class extends AbstractProduction {
  constructor(options) {
    super(options.definition);
    this.idx = 1;
    assign_default(this, pickBy_default(options, (v) => v !== void 0));
  }
}, __name(_a16, "Repetition"), _a16);
var _a17;
var RepetitionWithSeparator = (_a17 = class extends AbstractProduction {
  constructor(options) {
    super(options.definition);
    this.idx = 1;
    assign_default(this, pickBy_default(options, (v) => v !== void 0));
  }
}, __name(_a17, "RepetitionWithSeparator"), _a17);
var _a18;
var Alternation = (_a18 = class extends AbstractProduction {
  get definition() {
    return this._definition;
  }
  set definition(value) {
...
}, __name(_a18, "Alternation"), _a18);
var _a19;
var Terminal = (_a19 = class {
  constructor(options) {
    this.idx = 1;
    assign_default(this, pickBy_default(options, (v) => v !== void 0));
  }
...
var IN = "_~IN~_";
var _a22;
var ResyncFollowsWalker = (_a22 = class extends RestWalker {
  constructor(topProd) {
    super();
...
}, __name(_a22, "ResyncFollowsWalker"), _a22);
...
var _a23;
var CharCodeFinder = (_a23 = class extends BaseRegExpVisitor {
...
}, __name(_a23, "CharCodeFinder"), _a23);
...
var _a25;
var GastRefResolverVisitor = (_a25 = class extends GAstVisitor {
...
}, __name(_a25, "GastRefResolverVisitor"), _a25);
var _a26;
var AbstractNextPossibleTokensWalker = (_a26 = class extends RestWalker {
...
}, __name(_a26, "AbstractNextPossibleTokensWalker"), _a26);
var _a27;
var NextAfterTokenWalker = (_a27 = class extends AbstractNextPossibleTokensWalker {
  constructor(topProd, path) {
    super(topProd, path);
    this.path = path;
...
}, __name(_a27, "NextAfterTokenWalker"), _a27);
var _a28;
var AbstractNextTerminalAfterProductionWalker = (_a28 = class extends RestWalker {
...
}, __name(_a28, "AbstractNextTerminalAfterProductionWalker"), _a28);
var _a29;
var NextTerminalAfterManyWalker = (_a29 = class extends AbstractNextTerminalAfterProductionWalker {
  walkMany(manyProd, currRest, prevRest) {
...
}, __name(_a29, "NextTerminalAfterManyWalker"), _a29);
var _a30;
var NextTerminalAfterManySepWalker = (_a30 = class extends AbstractNextTerminalAfterProductionWalker {
  walkManySep(manySepProd, currRest, prevRest) {
...
}, __name(_a30, "NextTerminalAfterManySepWalker"), _a30);
var _a31;
var NextTerminalAfterAtLeastOneWalker = (_a31 = class extends AbstractNextTerminalAfterProductionWalker {
  walkAtLeastOne(atLeastOneProd, currRest, prevRest) {
...
}, __name(_a31, "NextTerminalAfterAtLeastOneWalker"), _a31);
var _a32;
var NextTerminalAfterAtLeastOneSepWalker = (_a32 = class extends AbstractNextTerminalAfterProductionWalker {
  walkAtLeastOneSep(atleastOneSepProd, currRest, prevRest) {
...
}, __name(_a32, "NextTerminalAfterAtLeastOneSepWalker"), _a32);
...
var _a33;
var RestDefinitionFinderWalker = (_a33 = class extends RestWalker {
...
}, __name(_a33, "RestDefinitionFinderWalker"), _a33);
var _a34;
var InsideDefinitionFinderVisitor = (_a34 = class extends GAstVisitor {
...
}, __name(_a34, "InsideDefinitionFinderVisitor"), _a34);
...
var _a35;
var OccurrenceValidationCollector = (_a35 = class extends GAstVisitor {
  constructor() {
    super(...arguments);
    this.allProductions = [];
  }
...
}, __name(_a35, "OccurrenceValidationCollector"), _a35);
...
var _a36;
var OrCollector = (_a36 = class extends GAstVisitor {
  constructor() {
    super(...arguments);
    this.alternations = [];
  }
...
var _a37;
var RepetitionCollector = (_a37 = class extends GAstVisitor {
  constructor() {
    super(...arguments);
    this.allProductions = [];
  }
...
}, __name(_a37, "RepetitionCollector"), _a37);
...
var _a38;
var RecognitionException = (_a38 = class extends Error {
...
}, __name(_a38, "RecognitionException"), _a38);
var _a39;
var MismatchedTokenException = (_a39 = class extends RecognitionException {
  constructor(message, token, previousToken) {
    super(message, token);
    this.previousToken = previousToken;
    this.name = MISMATCHED_TOKEN_EXCEPTION;
  }
}, __name(_a39, "MismatchedTokenException"), _a39);
var _a40;
var NoViableAltException = (_a40 = class extends RecognitionException {
  constructor(message, token, previousToken) {
    super(message, token);
    this.previousToken = previousToken;
    this.name = NO_VIABLE_ALT_EXCEPTION;
  }
}, __name(_a40, "NoViableAltException"), _a40);
var _a41;
var NotAllInputParsedException = (_a41 = class extends RecognitionException {
  constructor(message, token) {
    super(message, token);
    this.name = NOT_ALL_INPUT_PARSED_EXCEPTION;
  }
}, __name(_a41, "NotAllInputParsedException"), _a41);
var _a42;
var EarlyExitException = (_a42 = class extends RecognitionException {
  constructor(message, token, previousToken) {
    super(message, token);
    this.previousToken = previousToken;
    this.name = EARLY_EXIT_EXCEPTION;
  }
}, __name(_a42, "EarlyExitException"), _a42);
var EOF_FOLLOW_KEY = {};
var IN_RULE_RECOVERY_EXCEPTION = "InRuleRecoveryException";
var _a43;
var InRuleRecoveryException = (_a43 = class extends Error {
  constructor(message) {
    super(message);
    this.name = IN_RULE_RECOVERY_EXCEPTION;
  }
}, __name(_a43, "InRuleRecoveryException"), _a43);
var _a44;
var Recoverable = (_a44 = class {
...
var _a45;
var LLkLookaheadStrategy = (_a45 = class {
  constructor(options) {
    var _a130;
    this.maxLookahead = (_a130 = options === null || options === void 0 ? void 0 : options.maxLookahead) !== null && _a130 !== void 0 ? _a130 : DEFAULT_PARSER_CONFIG.maxLookahead;
  }
  validate(options) {
...
}, __name(_a45, "LLkLookaheadStrategy"), _a45);
var _a46;
var LooksAhead = (_a46 = class {
...
}, __name(_a46, "LooksAhead"), _a46);
var _a47;
var DslMethodsCollectorVisitor = (_a47 = class extends GAstVisitor {
  constructor() {
    super(...arguments);
    this.dslMethods = {
      option: [],
...
}, __name(_a47, "DslMethodsCollectorVisitor"), _a47);
...
}, __name(_a48, "TreeBuilder"), _a48);
var _a49;
var LexerAdapter = (_a49 = class {
  initLexerAdapter() {
    this.tokVector = [];
...
}, __name(_a49, "LexerAdapter"), _a49);
var _a50;
var RecognizerApi = (_a50 = class {
  ACTION(impl) {
...
}, __name(_a50, "RecognizerApi"), _a50);
var _a51;
var RecognizerEngine = (_a51 = class {
...
}, __name(_a51, "RecognizerEngine"), _a51);
var _a52;
var ErrorHandler = (_a52 = class {
...
}, __name(_a52, "ErrorHandler"), _a52);
var _a53;
var ContentAssist = (_a53 = class {
  initContentAssist() {
  }
...
}, __name(_a53, "ContentAssist"), _a53);
...
var _a55;
var PerformanceTracer = (_a55 = class {
...
}, __name(_a55, "PerformanceTracer"), _a55);
    ...
    this.TRACE_INIT("performSelfAnalysis", () => {
      ...
      if (isEmpty_default(this.definitionErrors)) {
        ...
        this.TRACE_INIT("ComputeLookaheadFunctions", () => {
          var _a130, _b;
          (_b = (_a130 = this.lookaheadStrategy).initialize) === null || _b === void 0 ? void 0 : _b.call(_a130, {
            rules: values_default(this.gastProductionsCache)
          });
          this.preComputeLookaheadFunctions(values_default(this.gastProductionsCache));
        });
      }
      if (!_a56.DEFER_DEFINITION_ERRORS_HANDLING && !isEmpty_default(this.definitionErrors)) {
...
var _a57;
var EmbeddedActionsParser = (_a57 = class extends Parser {
  constructor(tokenVocabulary, config = DEFAULT_PARSER_CONFIG) {
    const configClone = clone_default(config);
    configClone.outputCst = false;
    super(tokenVocabulary, configClone);
  }
}, __name(_a57, "EmbeddedActionsParser"), _a57);
...
var ATN_LOOP_END = 12;
var _a58;
var AbstractTransition = (_a58 = class {
  constructor(target) {
    this.target = target;
  }
  isEpsilon() {
...
}, __name(_a58, "AbstractTransition"), _a58);
var _a59;
var AtomTransition = (_a59 = class extends AbstractTransition {
  constructor(target, tokenType) {
    super(target);
    this.tokenType = tokenType;
  }
}, __name(_a59, "AtomTransition"), _a59);
var _a60;
var EpsilonTransition = (_a60 = class extends AbstractTransition {
  constructor(target) {
    super(target);
  }
  isEpsilon() {
...
}, __name(_a60, "EpsilonTransition"), _a60);
var _a61;
var RuleTransition = (_a61 = class extends AbstractTransition {
...
}, __name(_a61, "RuleTransition"), _a61);
...
}, __name(_a63, "PredicateSet"), _a63);
var EMPTY_PREDICATES = new PredicateSet();
var _a64;
var LLStarLookaheadStrategy = (_a64 = class extends LLkLookaheadStrategy {
  constructor(options) {
    var _a130;
    super();
    this.logging = (_a130 = options === null || options === void 0 ? void 0 : options.logging) !== null && _a130 !== void 0 ? _a130 : (message) => console.log(message);
  }
  initialize(options) {
      ...
      if (hasPredicates) {
        return function(orAlts) {
          ...
          if (orAlts !== void 0 && prediction !== void 0) {
            const gate = (_a130 = orAlts[prediction]) === null || _a130 === void 0 ? void 0 : _a130.GATE;
...
}, __name(_a64, "LLStarLookaheadStrategy"), _a64);
...
(function(Diagnostic2) {
  ...
  function is(value) {
    var _a130;
    let candidate = value;
    return Is.defined(candidate) && Range.is(candidate.range) && Is.string(candidate.message) && (Is.number(candidate.severity) || Is.undefined(candidate.severity)) && (Is.integer(candidate.code) || Is.string(candidate.code) || Is.undefined(candidate.code)) && (Is.undefined(candidate.codeDescription) || Is.string((_a130 = candidate.codeDescription) === null || _a130 === void 0 ? void 0 : _a130.href)) && (Is.string(candidate.source) || Is.undefined(candidate.source)) && (Is.undefined(candidate.relatedInformation) || Is.typedArray(candidate.relatedInformation, DiagnosticRelatedInformation.is));
  }
  __name(is, "is");
  Diagnostic2.is = is;
...
var _a65;
var FullTextDocument = (_a65 = class {
...
}, __name(_a65, "FullTextDocument"), _a65);
var Is;
(function(Is2) {
...
var _a66;
var CstNodeBuilder = (_a66 = class {
  constructor() {
    this.nodeStack = [];
  }
  get current() {
    var _a130;
    return (_a130 = this.nodeStack[this.nodeStack.length - 1]) !== null && _a130 !== void 0 ? _a130 : this.rootNode;
  }
  buildRootNode(input) {
...
}, __name(_a66, "CstNodeBuilder"), _a66);
var _a67;
var AbstractCstNode = (_a67 = class {
  ...
  get astNode() {
    var _a130, _b;
    const node = typeof ((_a130 = this._astNode) === null || _a130 === void 0 ? void 0 : _a130.$type) === "string" ? this._astNode : (_b = this.container) === null || _b === void 0 ? void 0 : _b.astNode;
    if (!node) {
...
}, __name(_a67, "AbstractCstNode"), _a67);
var _a68;
var LeafCstNodeImpl = (_a68 = class extends AbstractCstNode {
  get offset() {
    return this._offset;
  }
  get length() {
...
}, __name(_a68, "LeafCstNodeImpl"), _a68);
var _a69;
var CompositeCstNodeImpl = (_a69 = class extends AbstractCstNode {
  constructor() {
    super(...arguments);
  ...
  get offset() {
    var _a130, _b;
    return (_b = (_a130 = this.firstNonHiddenNode) === null || _a130 === void 0 ? void 0 : _a130.offset) !== null && _b !== void 0 ? _b : 0;
  }
  get length() {
  ...
  get end() {
    var _a130, _b;
    return (_b = (_a130 = this.lastNonHiddenNode) === null || _a130 === void 0 ? void 0 : _a130.end) !== null && _b !== void 0 ? _b : 0;
  }
  get range() {
...
}, __name(_a69, "CompositeCstNodeImpl"), _a69);
var _a70;
var CstNodeContainer = (_a70 = class extends Array {
  constructor(parent) {
    super();
    this.parent = parent;
    Object.setPrototypeOf(this, _a70.prototype);
  }
  push(...items) {
...
}, __name(_a70, "CstNodeContainer"), _a70);
var _a71;
var RootCstNodeImpl = (_a71 = class extends CompositeCstNodeImpl {
  get text() {
...
}, __name(_a71, "RootCstNodeImpl"), _a71);
...
var _a72;
var AbstractLangiumParser = (_a72 = class {
...
}, __name(_a72, "AbstractLangiumParser"), _a72);
var _a73;
var LangiumParser = (_a73 = class extends AbstractLangiumParser {
  get current() {
...
}, __name(_a73, "LangiumParser"), _a73);
var _a74;
var AbstractParserErrorMessageProvider = (_a74 = class {
...
}, __name(_a74, "AbstractParserErrorMessageProvider"), _a74);
var _a75;
var LangiumParserErrorMessageProvider = (_a75 = class extends AbstractParserErrorMessageProvider {
...
}, __name(_a75, "LangiumParserErrorMessageProvider"), _a75);
var _a76;
var LangiumCompletionParser = (_a76 = class extends AbstractLangiumParser {
  constructor() {
    super(...arguments);
    this.tokens = [];
    this.elementStack = [];
...
}, __name(_a76, "LangiumCompletionParser"), _a76);
var defaultConfig = {
  recoveryEnabled: true,
...
var _a77;
var ChevrotainWrapper = (_a77 = class extends EmbeddedActionsParser {
...
}, __name(_a77, "ChevrotainWrapper"), _a77);
...
var _a78;
var DefaultTokenBuilder = (_a78 = class {
  constructor() {
    this.diagnostics = [];
  }
...
}, __name(_a78, "DefaultTokenBuilder"), _a78);
var _a79;
var DefaultValueConverter = (_a79 = class {
  ...
  runConverter(rule, input, cstNode) {
    ...
    switch ((_a130 = getRuleType(rule)) === null || _a130 === void 0 ? void 0 : _a130.toLowerCase()) {
      case "number":
...
}, __name(_a79, "DefaultValueConverter"), _a79);
var ValueConverter;
...
}, __name(_a80, "Deferred"), _a80);
var _a81;
var FullTextDocument2 = (_a81 = class {
  constructor(uri, languageId, version, content) {
    this._uri = uri;
    this._languageId = languageId;
    this._version = version;
...
}, __name(_a81, "FullTextDocument"), _a81);
var TextDocument2;
(function(TextDocument3) {
  function create(uri, languageId, version, content) {
...
(() => {
  ...
  (() => {
    let t2;
    if (r.r(n), r.d(n, { URI: __name(() => f, "URI"), Utils: __name(() => P, "Utils") }), "object" == typeof process) t2 = "win32" === process.platform;
...
var _a82;
var DefaultLangiumDocumentFactory = (_a82 = class {
  constructor(services) {
  ...
  async update(document, cancellationToken) {
    var _a130, _b;
    const oldText = (_a130 = document.parseResult.value.$cstNode) === null || _a130 === void 0 ? void 0 : _a130.root.fullText;
...
}, __name(_a82, "DefaultLangiumDocumentFactory"), _a82);
var _a83;
var DefaultLangiumDocuments = (_a83 = class {
  constructor(services) {
...
}, __name(_a83, "DefaultLangiumDocuments"), _a83);
var ref_resolving = Symbol("ref_resolving");
var _a84;
var DefaultLinker = (_a84 = class {
  constructor(services) {
  ...
  doLink(refInfo, document) {
    ...
    if (ref._ref === void 0) {
      ...
      try {
        ...
        const errorMessage = (_a130 = err.message) !== null && _a130 !== void 0 ? _a130 : String(err);
    ...
    const reference = {
      ...
      get ref() {
        ...
        if (isAstNode(this._ref)) {
          ...
          this._ref = (_a130 = refData.node) !== null && _a130 !== void 0 ? _a130 : refData.error;
...
}, __name(_a84, "DefaultLinker"), _a84);
function isNamed(node) {
  return typeof node.name === "string";
}
__name(isNamed, "isNamed");
var _a85;
var DefaultNameProvider = (_a85 = class {
  getName(node) {
    if (isNamed(node)) {
      return node.name;
    }
...
}, __name(_a85, "DefaultNameProvider"), _a85);
var _a86;
var DefaultReferences = (_a86 = class {
  constructor(services) {
...
}, __name(_a86, "DefaultReferences"), _a86);
var _a87;
var MultiMap = (_a87 = class {
  ...
  get(key) {
    var _a130;
    return (_a130 = this.map.get(key)) !== null && _a130 !== void 0 ? _a130 : [];
  }
  /**
   * Operates differently depending on whether a `value` is given:
...
}, __name(_a87, "MultiMap"), _a87);
var _a88;
var BiMap = (_a88 = class {
  get size() {
...
}, __name(_a88, "BiMap"), _a88);
var _a89;
var DefaultScopeComputation = (_a89 = class {
  constructor(services) {
    this.nameProvider = services.references.NameProvider;
...
}, __name(_a89, "DefaultScopeComputation"), _a89);
var _a90;
var StreamScope = (_a90 = class {
  constructor(elements, outerScope, options) {
    var _a130;
    this.elements = elements;
    this.outerScope = outerScope;
    this.caseInsensitive = (_a130 = options === null || options === void 0 ? void 0 : options.caseInsensitive) !== null && _a130 !== void 0 ? _a130 : false;
  }
  getAllElements() {
    if (this.outerScope) {
...
}, __name(_a90, "StreamScope"), _a90);
var _a91;
var MapScope = (_a91 = class {
  constructor(elements, outerScope, options) {
    var _a130;
...
var _a92;
var DisposableCache = (_a92 = class {
  constructor() {
    this.toDispose = [];
...
}, __name(_a92, "DisposableCache"), _a92);
var _a93;
var SimpleCache = (_a93 = class extends DisposableCache {
  constructor() {
    super(...arguments);
...
}, __name(_a93, "SimpleCache"), _a93);
var _a94;
var ContextCache = (_a94 = class extends DisposableCache {
...
}, __name(_a94, "ContextCache"), _a94);
var _a95;
var DocumentCache = (_a95 = class extends ContextCache {
  /**
...
}, __name(_a95, "DocumentCache"), _a95);
var _a96;
var WorkspaceCache = (_a96 = class extends SimpleCache {
  /**
...
}, __name(_a96, "WorkspaceCache"), _a96);
var _a97;
var DefaultScopeProvider = (_a97 = class {
  constructor(services) {
    this.reflection = services.shared.AstReflection;
    this.nameProvider = services.references.NameProvider;
    this.descriptions = services.workspace.AstNodeDescriptionProvider;
...
}, __name(_a97, "DefaultScopeProvider"), _a97);
...
var _a98;
var DefaultJsonSerializer = (_a98 = class {
  constructor(services) {
  ...
  replacer(key, value, { refText, sourceText, textRegions, comments, uriConverter }) {
    ...
    if (this.ignoreProperties.has(key)) {
      ...
      if (refValue) {
        ...
        return {
          $error: (_b = (_a130 = value.error) === null || _a130 === void 0 ? void 0 : _a130.message) !== null && _b !== void 0 ? _b : "Could not resolve reference",
          $refText
        };
      }
    } else if (isAstNode(value)) {
...
}, __name(_a98, "DefaultJsonSerializer"), _a98);
var _a99;
var DefaultServiceRegistry = (_a99 = class {
  /**
  ...
  getServices(uri) {
    ...
    const languageId = (_b = (_a130 = this.textDocuments) === null || _a130 === void 0 ? void 0 : _a130.get(uri)) === null || _b === void 0 ? void 0 : _b.languageId;
...
}, __name(_a99, "DefaultServiceRegistry"), _a99);
...
var _a100;
var ValidationRegistry = (_a100 = class {
  constructor(services) {
...
}, __name(_a100, "ValidationRegistry"), _a100);
var _a101;
var DefaultDocumentValidator = (_a101 = class {
  constructor(services) {
  ...
  async validateDocument(document, options = {}, cancelToken = cancellation_exports.CancellationToken.None) {
    ...
    if (!options.categories || options.categories.includes("built-in")) {
      ...
      if (options.stopAfterLexingErrors && diagnostics.some((d) => {
        var _a130;
        return ((_a130 = d.data) === null || _a130 === void 0 ? void 0 : _a130.code) === DocumentValidator.LexingError;
      })) {
        return diagnostics;
      }
      ...
      if (options.stopAfterParsingErrors && diagnostics.some((d) => {
        var _a130;
        return ((_a130 = d.data) === null || _a130 === void 0 ? void 0 : _a130.code) === DocumentValidator.ParsingError;
      })) {
        return diagnostics;
      }
      ...
      if (options.stopAfterLinkingErrors && diagnostics.some((d) => {
        var _a130;
        return ((_a130 = d.data) === null || _a130 === void 0 ? void 0 : _a130.code) === DocumentValidator.LinkingError;
      })) {
        return diagnostics;
      }
    }
  ...
  processLexingErrors(parseResult, diagnostics, _options) {
    var _a130, _b, _c;
    const lexerDiagnostics = [...parseResult.lexerErrors, ...(_b = (_a130 = parseResult.lexerReport) === null || _a130 === void 0 ? void 0 : _a130.diagnostics) !== null && _b !== void 0 ? _b : []];
  ...
  async validateAstBefore(rootNode, options, acceptor, cancelToken = cancellation_exports.CancellationToken.None) {
    ...
    for (const checkBefore of checksBefore) {
      await interruptAndCheck(cancelToken);
      await checkBefore(rootNode, acceptor, (_a130 = options.categories) !== null && _a130 !== void 0 ? _a130 : [], cancelToken);
    }
  }
  ...
  async validateAstAfter(rootNode, options, acceptor, cancelToken = cancellation_exports.CancellationToken.None) {
    ...
    for (const checkAfter of checksAfter) {
      await interruptAndCheck(cancelToken);
      await checkAfter(rootNode, acceptor, (_a130 = options.categories) !== null && _a130 !== void 0 ? _a130 : [], cancelToken);
    }
  }
...
}, __name(_a101, "DefaultDocumentValidator"), _a101);
...
var _a102;
var DefaultAstNodeDescriptionProvider = (_a102 = class {
  constructor(services) {
    this.astNodeLocator = services.workspace.AstNodeLocator;
    this.nameProvider = services.references.NameProvider;
  }
  createDescription(node, name, document) {
    ...
    let nameNodeSegment;
    const nameSegmentGetter = __name(() => {
      var _a130;
      return nameNodeSegment !== null && nameNodeSegment !== void 0 ? nameNodeSegment : nameNodeSegment = toDocumentSegment((_a130 = this.nameProvider.getNameNode(node)) !== null && _a130 !== void 0 ? _a130 : node.$cstNode);
    }, "nameSegmentGetter");
    return {
      node,
      name,
...
}, __name(_a102, "DefaultAstNodeDescriptionProvider"), _a102);
var _a103;
var DefaultReferenceDescriptionProvider = (_a103 = class {
  constructor(services) {
    this.nodeLocator = services.workspace.AstNodeLocator;
  }
...
}, __name(_a103, "DefaultReferenceDescriptionProvider"), _a103);
var _a104;
var DefaultAstNodeLocator = (_a104 = class {
  constructor() {
...
}, __name(_a104, "DefaultAstNodeLocator"), _a104);
var event_exports = {};
__reExport(event_exports, __toESM(require_events(), 1));
var _a105;
var DefaultConfigurationProvider = (_a105 = class {
  constructor(services) {
  ...
  initialize(params) {
    var _a130, _b;
    this.workspaceConfig = (_b = (_a130 = params.capabilities.workspace) === null || _a130 === void 0 ? void 0 : _a130.configuration) !== null && _b !== void 0 ? _b : false;
  }
...
}, __name(_a105, "DefaultConfigurationProvider"), _a105);
var Disposable;
...
var _a106;
var DefaultDocumentBuilder = (_a106 = class {
  constructor(services) {
    ...
    for (const document of documents) {
      ...
      if (document.state === DocumentState.Validated) {
        if (typeof options.validation === "boolean" && options.validation) {
          ...
          const previousCategories = (_a130 = buildState === null || buildState === void 0 ? void 0 : buildState.result) === null || _a130 === void 0 ? void 0 : _a130.validationChecks;
  ...
  async update(changed, deleted, cancelToken = cancellation_exports.CancellationToken.None) {
    ...
    const rebuildDocuments = this.sortDocuments(this.langiumDocuments.all.filter((doc) => {
      var _a130;
      return doc.state < DocumentState.Linked || !((_a130 = this.buildState.get(doc.uri.toString())) === null || _a130 === void 0 ? void 0 : _a130.completed);
    }).toArray());
  ...
  hasTextDocument(doc) {
    var _a130;
    return Boolean((_a130 = this.textDocuments) === null || _a130 === void 0 ? void 0 : _a130.get(doc.uri));
  }
  /**
  ...
  async validate(document, cancelToken) {
    ...
    if (state) {
      (_a130 = state.result) !== null && _a130 !== void 0 ? _a130 : state.result = {};
  ...
  getBuildOptions(document) {
    var _a130, _b;
    return (_b = (_a130 = this.buildState.get(document.uri.toString())) === null || _a130 === void 0 ? void 0 : _a130.options) !== null && _b !== void 0 ? _b : {};
  }
}, __name(_a106, "DefaultDocumentBuilder"), _a106);
var _a107;
var DefaultIndexManager = (_a107 = class {
  constructor(services) {
  ...
  getFileDescriptions(uri, nodeType) {
    var _a130;
    if (!nodeType) {
      return (_a130 = this.symbolIndex.get(uri)) !== null && _a130 !== void 0 ? _a130 : [];
    }
    const descriptions = this.symbolByTypeIndex.get(uri, nodeType, () => {
      var _a210;
      const allFileDescriptions = (_a210 = this.symbolIndex.get(uri)) !== null && _a210 !== void 0 ? _a210 : [];
...
}, __name(_a107, "DefaultIndexManager"), _a107);
var _a108;
var DefaultWorkspaceManager = (_a108 = class {
  constructor(services) {
  ...
  initialize(params) {
    var _a130;
    this.folders = (_a130 = params.workspaceFolders) !== null && _a130 !== void 0 ? _a130 : void 0;
  }
  initialized(_params) {
    return this.mutex.write((token) => {
      var _a130;
      return this.initializeWorkspace((_a130 = this.folders) !== null && _a130 !== void 0 ? _a130 : [], token);
    });
  }
...
}, __name(_a108, "DefaultWorkspaceManager"), _a108);
var _a109;
var DefaultLexerErrorMessageProvider = (_a109 = class {
  buildUnexpectedCharactersMessage(fullText, startOffset, length, line, column) {
...
}, __name(_a109, "DefaultLexerErrorMessageProvider"), _a109);
var DEFAULT_TOKENIZE_OPTIONS = { mode: "full" };
var _a110;
var DefaultLexer = (_a110 = class {
  constructor(services) {
  ...
  tokenize(text, _options = DEFAULT_TOKENIZE_OPTIONS) {
    ...
    return {
      ...
      hidden: (_a130 = chevrotainResult.groups.hidden) !== null && _a130 !== void 0 ? _a130 : [],
...
}, __name(_a110, "DefaultLexer"), _a110);
...
function tokenize(context) {
  ...
  for (let i = 0; i < context.lines.length; i++) {
    ...
    if (first2 && context.options.start) {
      const match = (_a130 = context.options.start) === null || _a130 === void 0 ? void 0 : _a130.exec(line);
      if (match) {
...
function parseJSDocComment(context) {
  ...
  const start = (_b = (_a130 = elements[0]) === null || _a130 === void 0 ? void 0 : _a130.range.start) !== null && _b !== void 0 ? _b : startPosition;
...
var _a111;
var JSDocCommentImpl = (_a111 = class {
...
}, __name(_a111, "JSDocCommentImpl"), _a111);
var _a112;
var JSDocTagImpl = (_a112 = class {
...
${content}`;
  ...
  toMarkdown(options) {
    var _a130, _b;
    return (_b = (_a130 = options === null || options === void 0 ? void 0 : options.renderTag) === null || _a130 === void 0 ? void 0 : _a130.call(options, this)) !== null && _b !== void 0 ? _b : this.toMarkdownDefault(options);
  }
...
}, __name(_a112, "JSDocTagImpl"), _a112);
function renderInlineTag(tag, content, options) {
  ...
  if (tag === "linkplain" || tag === "linkcode" || tag === "link") {
    ...
    const renderedLink = (_b = (_a130 = options.renderLink) === null || _a130 === void 0 ? void 0 : _a130.call(options, content, display)) !== null && _b !== void 0 ? _b : renderLinkDefault(content, display);
    return renderedLink;
  }
  return void 0;
}
...
}, __name(_a113, "JSDocTextImpl"), _a113);
var _a114;
var JSDocLineImpl = (_a114 = class {
...
}, __name(_a114, "JSDocLineImpl"), _a114);
...
var _a115;
var JSDocDocumentationProvider = (_a115 = class {
  constructor(services) {
    this.indexManager = services.shared.workspace.IndexManager;
    this.commentProvider = services.documentation.CommentProvider;
  }
  ...
  documentationLinkRenderer(node, name, display) {
    var _a130;
    const description = (_a130 = this.findNameInPrecomputedScopes(node, name)) !== null && _a130 !== void 0 ? _a130 : this.findNameInGlobalScope(node, name);
...
}, __name(_a115, "JSDocDocumentationProvider"), _a115);
var _a116;
var DefaultCommentProvider = (_a116 = class {
  constructor(services) {
  ...
  getComment(node) {
    ...
    return (_a130 = findCommentNode(node.$cstNode, this.grammarConfig().multilineCommentRules)) === null || _a130 === void 0 ? void 0 : _a130.text;
  }
}, __name(_a116, "DefaultCommentProvider"), _a116);
var _a117;
var DefaultAsyncParser = (_a117 = class {
  constructor(services) {
...
}, __name(_a117, "DefaultAsyncParser"), _a117);
var _a118;
var AbstractThreadedAsyncParser = (_a118 = class {
  constructor(services) {
    this.threadCount = 8;
...
}, __name(_a118, "AbstractThreadedAsyncParser"), _a118);
var _a119;
var ParserWorker = (_a119 = class {
  get ready() {
    return this._ready;
  }
  get onReady() {
...
}, __name(_a119, "ParserWorker"), _a119);
var _a120;
var DefaultWorkspaceLock = (_a120 = class {
  constructor() {
...
}, __name(_a120, "DefaultWorkspaceLock"), _a120);
var _a121;
var DefaultHydrator = (_a121 = class {
  constructor(services) {
...
}, __name(_a121, "DefaultHydrator"), _a121);
...
var _a122;
var IndentationAwareTokenBuilder = (_a122 = class extends DefaultTokenBuilder {
  ...
  matchWhitespace(text, offset, tokens, groups) {
    ...
    return {
      currIndentLevel: (_a130 = match === null || match === void 0 ? void 0 : match[0].length) !== null && _a130 !== void 0 ? _a130 : 0,
  ...
  dedentMatcher(text, offset, tokens, groups) {
    ...
    if (matchIndentIndex === -1) {
      this.diagnostics.push({
        ...
        offset,
        length: (_b = (_a130 = match === null || match === void 0 ? void 0 : match[0]) === null || _a130 === void 0 ? void 0 : _a130.length) !== null && _b !== void 0 ? _b : 0,
...
}, __name(_a122, "IndentationAwareTokenBuilder"), _a122);
var _a123;
var IndentationAwareLexer = (_a123 = class extends DefaultLexer {
  constructor(services) {
    super(services);
...
}, __name(_a123, "IndentationAwareLexer"), _a123);
var utils_exports = {};
...
var _a124;
var EmptyFileSystemProvider = (_a124 = class {
  readFile() {
...
}, __name(_a124, "EmptyFileSystemProvider"), _a124);
var EmptyFileSystem = {
...
function loadGrammarFromJson(json) {
  ...
  services.shared.workspace.LangiumDocumentFactory.fromModel(astNode, URI2.parse(`memory://${(_a130 = astNode.name) !== null && _a130 !== void 0 ? _a130 : "grammar"}.langium`));
  return astNode;
}
...
var Section = "Section";
var _a125;
var MermaidAstReflection = (_a125 = class extends AbstractAstReflection {
  getAllTypes() {
...
}, __name(_a125, "MermaidAstReflection"), __name2(_a125, "MermaidAstReflection"), _a125);
...
var _a126;
var AbstractMermaidValueConverter = (_a126 = class extends DefaultValueConverter {
  runConverter(rule, input, cstNode) {
...
}, __name(_a126, "AbstractMermaidValueConverter"), __name2(_a126, "AbstractMermaidValueConverter"), _a126);
var _a127;
var CommonValueConverter = (_a127 = class extends AbstractMermaidValueConverter {
  runCustomConverter(_rule, _input, _cstNode) {
    return void 0;
  }
}, __name(_a127, "CommonValueConverter"), __name2(_a127, "CommonValueConverter"), _a127);
var _a128;
var AbstractMermaidTokenBuilder = (_a128 = class extends DefaultTokenBuilder {
...
}, __name(_a128, "AbstractMermaidTokenBuilder"), __name2(_a128, "AbstractMermaidTokenBuilder"), _a128);
var _a129;
var CommonTokenBuilder = (_a129 = class extends AbstractMermaidTokenBuilder {
}, __name(_a129, "CommonTokenBuilder"), __name2(_a129, "CommonTokenBuilder"), _a129);
...
//# sourceMappingURL=chunk-O5CRT6IX.js.map
